...
void armor_param_init()
{
    ...
    armor_param.BLUE_CR_MAX = 100;
    armor_param.BLUE_CR_MIN = 0;
    armor_param.BLUE_CB_MAX = 255;
    armor_param.BLUE_CB_MIN = 100;
    ...
    armor_param.ARMOR_LENGTH_DIFF_RATIO = 30;
    armor_param.ARMOR_WIDTH_DIFF_RATIO = 30;
    armor_param.ARMOR_MAX_HORIZONTAL_ANGLE = 15;
    armor_param.ARMOR_AREA_MAX = 1000;
